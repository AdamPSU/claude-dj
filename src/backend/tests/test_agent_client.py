...
from claude_dj.agent.client import ClaudeDJ, build_agent_options
...
class ClaudeDJClientTests(unittest.IsolatedAsyncioTestCase):
    async def test_agent_options_use_opus_4_7_with_medium_effort(self) -> None:
        with patch("claude_dj.agent.client.build_dj_mcp_server", return_value={"type": "sdk"}):
